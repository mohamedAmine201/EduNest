...
class CourseWithTeacherSerializer(serializers.ModelSerializer):
    nom     = serializers.CharField(source='teacher.user.last_name')
    prenom  = serializers.CharField(source='teacher.user.first_name')
    email   = serializers.EmailField(source='teacher.user.email')
    course  = serializers.CharField(source='name')
    user_id = serializers.IntegerField(source='teacher.user.id')
